...
---
Decided to put together this analysis to demonstrate three concepts for my physiology of exercise class. 

First concept is that it is important to analyze vertical jump based on power, not inches or centimeters. This is true due to the wide variation in power associated with the subjects body mass.
