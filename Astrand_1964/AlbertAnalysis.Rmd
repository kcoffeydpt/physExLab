...
Astrand database: heart rate will be compared to the different stages of the vo2max and see if there is a correlation. Also resting heart rate will be compared to max vo2 and submaximal heart rate and max heart rate. Max heart rate will be calculate for all subjects as well. 

To do this, there will be many graphs, scatter plots and data charts."
